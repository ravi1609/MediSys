...
<div class="col-sm-4">
 <s:textfield cssClass="form-control" name="report_id" id="report_id"   value="%{max_report_id}" readonly="true" onchange="chkNumeric(this);" ></s:textfield>
</div>
</div> <!-- / .form-group -->
...
<div class="form-group">
<label for="inputEmail2" class="col-sm-3 control-label">Report Name:</label>
<div class="col-sm-4">
 
 <s:textfield cssClass="form-control" name="report_name" id="report_name"   onkeyup="chkStringspc(this);"></s:textfield>
</div>
</div> <!-- / .form-group -->


<div class="form-group">
<label for="inputEmail2" class="col-sm-3 control-label">Report Xml Name:</label>
<div class="col-sm-4">
 
<s:textfield cssClass="form-control" name="report_xml_name" id="report_xml_name"  required="true"  ></s:textfield>
</div>
</div> <!-- / .form-group -->
...
<div class="form-group">
<label for="inputEmail2" class="col-sm-3 control-label">Report Description:</label>
<div class="col-sm-4">
 

<s:textfield cssClass="form-control" name="report_desc" id="report_desc"  required="true" onkeyup="chkRemark(this);" ></s:textfield>
...
<div class="form-group">
<label for="inputEmail2" class="col-sm-3 control-label">Report Type:</label>
<div class="col-sm-4">
<!-- <input name="srno" id="srno"  value="%{max_link_id}" readonly="readonly" onchange="chkNumeric(this);"> -->
<s:select cssClass="form-control" cssStyle="margin: 0px 0px 0px 0px;" list="#{'0':'User','1':'Lab'}" name="report_type_id" id="report_type_id" required="true"  headerKey="-1" headerValue="--Select Type--" ></s:select>
...
<s:token></s:token>
  ...
  <s:hidden id="srno" name="srno"></s:hidden>
            ...
            <s:if test="user_report_list!=null">
  	<display:table  export="true" id="report_master_table" requestURIcontext="true"  name="user_report_list" requestURI="add_report_name" pagesize="30" cellpadding="2px;" cellspacing="0px;" style="margin:10px 0px 10px 0px; padding:0px 0px 0px 0px; width:723px; border:#98AFC7 1px solid; color:#115684; font-size:10px;"  >
				...
				<display:column property="report_id" title="Report Id" style="width: 80px; text-align:center;" ></display:column>
				<display:column property="report_name" title="Report Name" style="width: 80px; text-align:center;" ></display:column>
				<display:column property="report_xml_name" title="Report Xml Name" style="width: 80px; text-align:center;"></display:column>		
				<display:column property="report_desc" title="Report Description" style="width: 80px; text-align:center;"></display:column>						
				<display:column property="report_type_id" title="Report Type Id" style="width: 80px; text-align:center;"></display:column>
              ...
              <input type="button" onclick="editdetails('${report_master_table.report_id}','${report_master_table.report_name}', '${report_master_table.report_xml_name}','${report_master_table.report_desc}','${report_master_table.report_type_id}','${report_master_table.rcrd_status}');" value="EDIT">
			 </display:column>
 			</display:table>
